    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-cyber-blue font-sora max-w-3xl mx-auto">
            We're raising $500K to accelerate growth, expand our AI capabilities, and capture 
            a significant share of the $12B no-code platform market.
          </p>
        </motion.div>
        ...
        >
          <Link to="/investor-deck">
            <motion.button
              className="cyber-button text-lg px-12 py-6 inline-flex items-center space-x-3"
              whileHover={{ 
                scale: 1.05,
