          ...
          {services.map((service, index) => (
            ...
            >
              <motion.div
                layout
                className={`
                  bg-white/5 backdrop-blur-xl border ${service.borderColor} rounded-2xl p-6 
                  shadow-2xl hover:shadow-3xl transition-all duration-300
                  hover:bg-white/10 hover:border-opacity-50
                  ${expandedCard === index ? 'ring-2 ring-cyan-400/30' : ''}
                `}
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/70 font-sora text-sm leading-relaxed mb-4 group-hover:text-white/90 transition-colors duration-300">
