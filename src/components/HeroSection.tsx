...
const HeroSection = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        ...
        {[...Array(100)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-white rounded-full" style={{
        ...
        duration: 1
          ...
          <div className="mb-8 px-0 mx-0 my-0 py-0">
            ...
            fontFamily: "'Space Grotesk', 'Inter', sans-serif"
              ...
              {devLaunchLetters.map((letter, index) => <motion.span key={index} custom={index} variants={letterVariants} initial="hidden" animate="visible" whileHover="hover" transition={{
              delay: index * 0.1,
              duration: 0.8,
              type: "spring",
              stiffness: 100,
      ...
      return <motion.div key={index} className="absolute" style={bubble.position} initial={{
        opacity: 0,
        scale: 0
      }} animate={{
        opacity: 1,
        ...
        stiffness: 100
            ...
            <motion.div className={`relative w-32 h-32 rounded-full bg-gradient-to-br ${bubble.gradient} flex flex-col items-center justify-center cursor-pointer shadow-2xl group`} style={{
          ...
          transition: {
            ...
            delay: Math.random() * 2
              ...
              {/* Count */}
              <motion.div className="text-white text-sm font-bold font-orbitron relative z-10" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            delay: 2 + index * 0.1
              ...
              {/* Label on hover */}
              <motion.div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-white text-xs font-semibold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{
