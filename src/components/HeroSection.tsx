...
const HeroSection = () => {
  ...
  // Floating stats data
  const floatingStats = [
    { text: "50+ Projects", icon: Target, color: "bg-gradient-to-r from-purple-500 to-pink-500", delay: 0 },
    { text: "3 Years Experience", icon: Calendar, color: "bg-gradient-to-r from-orange-500 to-red-500", delay: 0.5 },
    { text: "24/7 Support", icon: Clock, color: "bg-gradient-to-r from-yellow-500 to-orange-500", delay: 1 },
    { text: "100% Success Rate", icon: Trophy, color: "bg-gradient-to-r from-green-500 to-teal-500", delay: 1.5 },
    { text: "Global Reach", icon: Globe, color: "bg-gradient-to-r from-blue-500 to-purple-500", delay: 2 },
    { text: "Expert Team", icon: Users, color: "bg-gradient-to-r from-pink-500 to-purple-500", delay: 2.5 }
  ];
        ...
        >
          ...
          >
            ...
            <motion.button 
              ...
              className="group px-8 py-4 border-2 border-cyber-blue text-cyber-blue hover:bg-cyber-blue hover:text-dark-space rounded-xl font-semibold text-lg transition-all duration-300"
            >
